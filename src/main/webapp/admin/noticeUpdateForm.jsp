                ...
                <div class="box">
                    <table>
                        ...
                        <tr>
                            <td>
                                <div class="form">
                                    <form method="post" id="form" name="writeform" action="/Movivum/noticeUpdatePro.do" onsubmit="return writeSave()">
                                        <div>
                                        	<input type="text" name="notice_subject" id="subject" 
                                        		placeholder="공지사항 제목을 입력해주세요."
                                        		value="${article.notice_subject }">
                                        </div>
                                        <div>
                                        	<textarea name="notice_content" cols="50" rows="10" id="content" placeholder="공지사항 내용을 입력해주세요.">${article.notice_content }</textarea>
                                        </div>
